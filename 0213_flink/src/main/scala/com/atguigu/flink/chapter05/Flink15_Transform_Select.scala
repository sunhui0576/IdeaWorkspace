...
/**
  ...
  */
object Flink15_Transform_Select {
  def main(args: Array[String]): Unit = {
    ...
    val normalDS: DataStream[WaterSensor] = splitSS.select("happy")
    val warnDS: DataStream[WaterSensor] = splitSS.select("warning")
    val alarmDS: DataStream[WaterSensor] = splitSS.select("alarm")
