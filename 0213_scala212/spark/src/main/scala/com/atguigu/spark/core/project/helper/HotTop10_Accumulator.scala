...
import com.atguigu.spark.core.exem.tes3_3.Word
import org.apache.spark.util.AccumulatorV2

import scala.collection.mutable

class HotTop10_Accumulator extends AccumulatorV2[String,mutable.Map[String,HotCategory]]{
  ...
  override def copy(): AccumulatorV2[String, mutable.Map[String, HotCategory]] = new HotTop10_Accumulator
