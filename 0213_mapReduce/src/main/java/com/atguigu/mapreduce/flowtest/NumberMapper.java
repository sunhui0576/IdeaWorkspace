...
public class NumberMapper extends Mapper<LongWritable, Text,Text, NumberBean> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        bean.setSumNum(Long.parseLong(split[split.length-3])+Long.parseLong(split[split.length-2]));
